  ...
  return async function (dispatch) {
    try {
      ...
      const { data } = await axios.post(
        "https://kriptees-backend.onrender.com/api/v1/login",
...
export function signUp(signupData) {
  ...
  return async function (dispatch) {
    try {
      ...
      const { data } = await axios.post(
        "https://kriptees-backend.onrender.com/api/v1/register",
...
export const load_UserProfile = () => async (dispatch) => {
  try {
    ...
    if (userData !== "undefined" && userData && userData !== undefined) {
      ...
      const { data } = await axios.get("https://kriptees-backend.onrender.com/api/v1/profile");
...
export function logout() {
  return async function (dispatch) {
    try {
      ...
      await axios.get(`https://kriptees-backend.onrender.com/api/v1/logout`); // token will expired from cookies and no more user data access
  ...
  return async function (dispatch) {
    try {
      ...
      const { data } = await axios.put(
        `https://kriptees-backend.onrender.com/api/v1/profile/update`,
...
export function updatePassword(userPassWord) {
  return async function (dispatch) {
    try {
      ...
      const { data } = await axios.put(
        `https://kriptees-backend.onrender.com/api/v1/password/update`,
...
export function forgetPassword(email) {
  return async function (dispatch) {
    try {
      ...
      const { data } = await axios.post(
        `https://kriptees-backend.onrender.com/api/v1/password/forgot`,
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `https://kriptees-backend.onrender.com/api/v1/password/reset/${token}`,
...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get("https://kriptees-backend.onrender.com/api/v1/admin/users",
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://kriptees-backend.onrender.com/api/v1/admin/user/${id}`, config);
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    const config = { headers: { "Content-Type": "application/json", Authorization: `${token}` } }
    const { data } = await axios.put(
      `https://kriptees-backend.onrender.com/api/v1/admin/user/${id}`, userData,
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://kriptees-backend.onrender.com/api/v1/admin/user/${id}`, config);
